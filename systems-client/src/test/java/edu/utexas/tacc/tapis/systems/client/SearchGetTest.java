...
//                 8=bucketName, 9=rootDir, 10=jobWorkingDir, 11=batchScheduler, 12=batchDefaultLogicalQueue
  ...
  public void testSortingSkip() throws Exception
  {
    ...
    sortBy = "id(asc)";
    searchResults = getClientUsr(serviceURL, adminUserJWT).getSystems(searchStr, DEFAULT_LIMIT, sortBy, DEFAULT_SKIP, DEFAULT_STARTAFTER, selectStr);
    ...
    sortBy = "id(asc)";
    limit = 4;
    searchResults = getClientUsr(serviceURL, adminUserJWT).getSystems(searchStr, limit, sortBy, DEFAULT_SKIP, DEFAULT_STARTAFTER, selectStr);
    ...
    limit = 2;
    skip = 5;
    searchResults = getClientUsr(serviceURL, adminUserJWT).getSystems(searchStr, limit, sortBy, skip, DEFAULT_STARTAFTER, selectStr);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
