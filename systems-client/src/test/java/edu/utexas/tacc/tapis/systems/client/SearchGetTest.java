...
//      if (i <= numSystems / 2)
//      {
//        try { getClientUsr(serviceURL, ownerUser1JWT).deleteSystem(systemId, true); }
//        catch (Exception e)
//        {
...
//      else
//      {
//        try { getClientUsr(serviceURL, ownerUser2JWT).deleteSystem(systemId, true); }
//        catch (Exception e)
//        {
//          System.out.println("Caught exception when deleting system: " + systemId + " Exception: " + e);
//        }
...
//    validCaseInputs.put(10,new CaseData(numSystems/2, "(id.like." + sysNameLikeAll + ")~(owner.eq." + ownerUser1 + ")"));  // Half owned by one user
//    validCaseInputs.put(11,new CaseData(numSystems/2, "(id.like." + sysNameLikeAll + ")~(owner.eq." + ownerUser2 + ")")); // and half owned by another
...
//    validCaseInputs.put(23,new CaseData(numSystems/2, "(id.like." + sysNameLikeAll + ")~(system_type.eq.LINUX)~(owner.neq." + ownerUser2 + ")"));
...
//    validCaseInputs.put(82,new CaseData(9, "(id.like." + sysNameLikeAll + ")~(enabled.eq.true)~(host.like.host" + testKey + "_00!)"));
//    validCaseInputs.put(83,new CaseData(11, "(id.like." + sysNameLikeAll + ")~(enabled.eq.true)~(host.nlike.host" + testKey + "_00!)"));
//    // Test that underscore and % get escaped as needed before being used as SQL
//    validCaseInputs.put(90,new CaseData(0, "(id.like." + sysNameLikeAll + ")~(host.like.host" + testKey + "_00_)"));
//    validCaseInputs.put(91,new CaseData(0, "(id.like." + sysNameLikeAll + ")~(host.like.host" + testKey + "_00%)"));
...
//    sortBy = "id(asc)";
//    searchResults = getClientUsr(serviceURL, adminUserJWT).getSystems(searchStr, DEFAULT_LIMIT, sortBy, DEFAULT_SKIP, DEFAULT_STARTAFTER);
...
//    sortBy = "id(asc)";
//    limit = 4;
//    searchResults = getClientUsr(serviceURL, adminUserJWT).getSystems(searchStr, limit, sortBy, DEFAULT_SKIP, DEFAULT_STARTAFTER);
...
//    limit = 2;
//    skip = 5;
//    searchResults = getClientUsr(serviceURL, adminUserJWT).getSystems(searchStr, limit, sortBy, skip, DEFAULT_STARTAFTER);
//    assertEquals(searchResults.size(), limit, "Incorrect result count");
