...
public class FilesClient implements ITapisClient
{
  ...
  // Timeouts.
  private static int DEFAULT_CLIENT_CONNECTION_TIMEOUT=60000;
  private static int DEFAULT_CLIENT_READ_TIMEOUT=60000;
  private static int DEFAULT_CLIENT_WRITE_TIMEOUT=60000;
          ...
          throws TapisClientException
  {
    ...
    try { resp = fileOperations.listFiles(systemId, path, limit, offset, recurse, impersonationId, sharedCtx); }
    catch (ApiException e) { Utils.throwTapisClientException(e.getCode(), e.getResponseBody(), e); }
    catch (Exception e) { Utils.throwTapisClientException(-1, null, e); }
  ...
  public List<FileInfo> listFiles(String systemId, String path, int limit, long offset, boolean recurse, String impersonationId)
          throws TapisClientException
  {
    return listFiles(systemId, path, limit, offset, recurse, impersonationId, sharedCtxNull);
  }
  ...
  public List<FileInfo> listFiles(String systemId, String path, int limit, long offset, boolean recurse)
          throws TapisClientException
  {
    return listFiles(systemId, path, limit, offset, recurse, impersonationIdNull, sharedCtxNull);
  }
   ...
   * @throws TapisClientException - If api call throws an exception
   */
  public StreamedFile getFileContents(String systemId, String path, boolean zip, String impersonationId, String sharedCtx)
          throws TapisClientException
  {
      ...
      try {
          Call call = fileContents.getContentsCall(systemId, path, null, zip, null, impersonationId, sharedCtx, null);
  ...
  {
    return getFileContents(systemId, path, zip, impersonationIdNull, sharedCtxNull);
  }
      ...
      throws TapisClientException
  {
    ...
    try {
      Call call = fileContents.getContentsCall(systemId, path, null, true, null, impersonationIdNull, sharedCtxNull, null);
      Response response =  call.execute();
      filename = FilenameUtils.removeExtension(filename) + ".zip";
  ...
  {
    return mkdir(systemId, path, sharedCtxNull);
  }
   ...
   * @throws TapisClientException - If api call throws an exception
   */
  public FileStringResponse mkdir(String systemId, String path, String sharedCtx) throws TapisClientException
  {
    FileStringResponse resp = null;
    var req = new MkdirRequest();
    req.setPath(path);
    try { resp = fileOperations.mkdir(systemId, sharedCtx, req); }
    catch (ApiException e) { Utils.throwTapisClientException(e.getCode(), e.getResponseBody(), e); }
    catch (Exception e) { Utils.throwTapisClientException(-1, null, e); }
    if (resp != null && resp.getResult() != null) return resp; else return null;
  }
