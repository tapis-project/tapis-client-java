#!/bin/sh
# Start up apps service using a docker image
...
# Apps service is available at http://localhost:8080/v3/apps
...
# Run docker image for Apps service
TAPIS_RUN_ENV=$1
TAG="tapis/apps:${TAPIS_RUN_ENV}"
